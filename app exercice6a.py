...
print("Calcule de la moyenne du CA par produit", ca_moyen_par_produit,sep="\n")

# Calcul du CA median par produit
ca_median_par_produit = df.groupby("produit")["CA"].median().reset_index()
print("Calcule de la mediane du CA par produit", ca_median_par_produit, sep="\n")